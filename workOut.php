...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO workout (name, username, join_date) VALUES ('$name', '$userName', '$join_date')";
...
<body>
    ...
    <div class="container">
        <header>
            <h1>🏠 Home Workout Challenge</h1>
            <p>No gym? No problem! Transform your body with effective home workouts.</p>
        </header>

        <section class="benefits">
            <h2>🔥 Key Benefits:</h2>
            <ul>
                <li>✅ <b>Perfect for home workouts</b> (no equipment needed)</li>
                <li>✅ <b>Time-efficient</b> workouts for busy schedules</li>
                <li>✅ <b>Full-body routines</b> that build strength & endurance</li>
            </ul>
        </section>
        ...
        <section class="included">
            ...
            <ul>
                <li>⏱️ Daily <b>20-30 min</b> guided workouts</li>
                <li>💪 Strength & flexibility training</li>
                <li>🔥 Warm-up & cooldown routines</li>
            </ul>
        </section>
