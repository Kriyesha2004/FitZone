...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO fullbody (name, username, join_date) VALUES ('$name', '$userName', '$join_date')";
...
<head>
    ...
    <title>Full Body Plan - 40% Off</title>
    <style>
        /* Modal Styling */
        .modal {
            display: none;
...
<body>
    ...
    <div class="container">
        <header>
            <h1>🔥 40% Off Full Body Plan</h1>
            <p>Build strength, flexibility, and endurance with this ultimate full-body workout program.</p>
        </header>

        <section class="benefits">
            <h2>🔥 Key Benefits:</h2>
            <ul>
                <li>✅ <b>Total-body transformation</b> with targeted workouts</li>
                <li>✅ <b>Strength, cardio, & flexibility</b> training mix</li>
                <li>✅ <b>Perfect for all fitness levels</b> (Beginner to Advanced)</li>
            </ul>
        </section>
        ...
        <section class="included">
            ...
            <ul>
                <li>🏋️‍♂️ Strength & resistance training plan</li>
                <li>🔥 Body recomposition strategies</li>
                <li>📊 Weekly progress tracking & motivation tips</li>
            </ul>
        </section>
